...
import type { lostfoundComment, lostfoundImg, lostfoundReport } from "./lostfound.schema";
...
export type LostFoundReport = typeof lostfoundReport.$inferSelect;
export type LostFoundImg = typeof lostfoundImg.$inferSelect;
export type LostFoundComment = typeof lostfoundComment.$inferSelect;
